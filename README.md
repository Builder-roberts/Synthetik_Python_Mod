...
# Version 2.6.1:
### NEW! Weaponspawn now GUARUNTEES one-weapon spawns from daily random run. As in, if you power token Nemesis, and only Nemesis,(close the game), use weaponspawn in Spawn menu, and use a daily run, you are GUARUNTEED to get Nemisis!
